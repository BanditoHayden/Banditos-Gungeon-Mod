...
namespace GungeonMod.Tiles
{
    public class PeaPlant : ModTile 
    {
        ...
        public override bool Drop(int i, int j)
        {
            ...
            if (growthStage > 0)
            {
                ...
                {
                    Item.NewItem(i * 16, j * 16, 0, 0, mod.ItemType("PeaSeeds"), Main.rand.Next(1, 6));
                    Item.NewItem(i * 16, j * 16, 0, 0, mod.ItemType("PeaPod"), Main.rand.Next(1, 3));
                }
                else if (growthStage == 2)
                {
                    Item.NewItem(i * 16, j * 16, 0, 0, mod.ItemType("PeaSeeds"), Main.rand.Next(1, 4));
                    Item.NewItem(i * 16, j * 16, 0, 0, mod.ItemType("PeaPod"));
                }
            }
